...
CREATE TABLE IF NOT EXISTS
    ...
    CHANGE_WITH_SAME_EMPLOYER_APPROVAL   VARCHAR,
    CHANGE_WITH_SAME_EMPLOYER_DENIAL     VARCHAR,
    NEW_CONCURRENT_APPROVAL              VARCHAR,
    NEW_CONCURRENT_DENIAL                VARCHAR,
    CHANGE_OF_EMPLOYER_APPROVAL          VARCHAR,
    CHANGE_OF_EMPLOYER_DENIAL            VARCHAR,
